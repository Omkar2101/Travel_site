...
const TimelineItem = memo(({ day, image, details, heading, description }) => {
    return (
        <li className="mb-10 ms-4 font-quicksand">
            ...
            <h3 className="text-xl mb-2 font-medium text-gray-900">{heading}</h3>
...
const TimeLineComp = ({ schedule }) => {
    return (
        <div className="px-4 md:px-40 mt-10">
            <h1 className="font-quicksand text-2xl text-orange-600">Insights</h1>
            <div className="mt-5">
